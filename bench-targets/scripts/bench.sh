...
default_chain_overrides() {
    ...
    case "${chain_name}" in
        diesis)
            ...
            local fec_shred_concurrency="${BENCH_DIESIS_E2E_FEC_MAX_CONCURRENT_SHRED_SENDS_PER_PEER:-${E2E_FEC_MAX_CONCURRENT_SHRED_SENDS_PER_PEER:-64}}"
            local fec_target_data_shreds="${BENCH_DIESIS_E2E_FEC_TARGET_DATA_SHREDS:-${E2E_FEC_TARGET_DATA_SHREDS:-64}}"
...
geo_chain_overrides() {
    ...
    [[ -n "${BENCH_GEO_E2E_FEC_TARGET_DATA_SHREDS:-}" ]] && overrides+=" E2E_FEC_TARGET_DATA_SHREDS=${BENCH_GEO_E2E_FEC_TARGET_DATA_SHREDS}"
    [[ -n "${BENCH_GEO_E2E_FEC_MAX_CONCURRENT_SHRED_SENDS_PER_PEER:-}" ]] && overrides+=" E2E_FEC_MAX_CONCURRENT_SHRED_SENDS_PER_PEER=${BENCH_GEO_E2E_FEC_MAX_CONCURRENT_SHRED_SENDS_PER_PEER}"
