...
default_chain_overrides() {
    ...
    case "${chain_name}" in
        diesis)
            ...
            local fec_target_data_shreds="${BENCH_DIESIS_E2E_FEC_TARGET_DATA_SHREDS:-${E2E_FEC_TARGET_DATA_SHREDS:-32}}"
...
geo_chain_overrides() {
    ...
    overrides+=" E2E_FEC_TARGET_DATA_SHREDS=${BENCH_GEO_E2E_FEC_TARGET_DATA_SHREDS:-32}"
