...
# Stop Diesis
DIESIS_BLOCK_PERIOD='200ms' DIESIS_ORDERING_WINDOW='20ms' DIESIS_MIN_ROUND_DELAY='10ms' \
DIESIS_MAX_BLOCK_TX_COUNT='5000' DIESIS_MAX_EXECUTION_LAG='16' DIESIS_PARALLEL_EXECUTION='full' \
